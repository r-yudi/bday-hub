  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <section className="rounded-3xl border border-black/10 bg-white/95 p-6 shadow-sm sm:p-8 dark:border-white/10 dark:bg-white/5">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-black/90 sm:text-[2rem] dark:text-white/90">Política de Privacidade</h1>
        <p className="mt-2 text-sm text-black/70 dark:text-white/70">Última atualização: 24 de fevereiro de 2026</p>
      </section>
      ...
      <section className="space-y-4 rounded-2xl border border-black/10 bg-white/90 p-5 text-sm text-black/75 shadow-sm dark:border-white/10 dark:bg-white/5 dark:text-white/75">
        <div>
          <h2 className="font-semibold tracking-tight text-black/85 dark:text-white/85">1. Dados coletados</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85 dark:text-white/85">2. Onde os dados ficam</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85 dark:text-white/85">3. Sessão e cookies</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85 dark:text-white/85">4. Como apagar dados</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85 dark:text-white/85">5. Compartilhamento</h2>
