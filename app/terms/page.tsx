  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <section className="rounded-3xl border border-black/10 bg-white/95 p-6 shadow-sm sm:p-8">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-black/90 sm:text-[2rem]">Termos de Uso</h1>
        <p className="mt-2 text-sm text-black/70">Versão simples para início de produto público.</p>
      </section>

      <section className="space-y-4 rounded-2xl border border-black/10 bg-white/90 p-5 shadow-sm text-sm text-black/75">
        <div>
          <h2 className="font-semibold tracking-tight text-black/85">1. Uso do serviço</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85">2. Disponibilidade</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85">3. Conta e autenticação</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-semibold tracking-tight text-black/85">4. Contato</h2>
