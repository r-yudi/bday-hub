...
### Changed
- **UX formulário /person + card do dia:** preview da mensagem sugerida é clicável para copiar (mantém botão Copiar e feedback “Mensagem copiada ✓”); microcopy “Clique ou toque na mensagem para copiar.”; WhatsApp/Instagram pedem só número e @/usuário; dicas dos campos com copy curta via botão **?** que abre/fecha painel inline (touch + teclado; sem depender de `title`/hover; Escape fecha).
