...
export function LandingPremiumPageClient() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-border bg-background px-4 py-6 sm:px-6 sm:py-10">
      ...
      <div className="pointer-events-none absolute -left-16 top-10 h-56 w-56 rounded-full glow-coral blur-3xl" />
      <div className="pointer-events-none absolute right-0 top-0 h-72 w-72 rounded-full glow-lilac blur-3xl" />
      <div className="pointer-events-none absolute bottom-10 right-16 h-40 w-40 rounded-full bg-warning/15 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-6xl space-y-10">
        <section className="grid items-center gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <Card variant="elevated" className="relative overflow-hidden p-5 sm:p-6">
            <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-primary/15 blur-2xl" />
            <div className="absolute -left-6 bottom-8 h-24 w-24 rounded-full bg-lilac/15 blur-2xl" />
        ...
        <section className="grid gap-4 lg:grid-cols-12">
          <Card variant="bento" className="lg:col-span-4 p-5">
