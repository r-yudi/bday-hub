...
export function LandingPageClient() {
  ...
  return (
    <div className="space-y-10">
      <section className="relative overflow-hidden rounded-3xl border border-black/10 bg-white/95 p-6 shadow-sm sm:p-10 dark:border-border dark:bg-surface/90">
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-black/10 bg-white/85 p-4 shadow-sm dark:border-border dark:bg-surface/85">
      ...
      <footer className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-black/10 bg-white/70 px-4 py-3 text-sm text-muted dark:border-border dark:bg-surface/70">
