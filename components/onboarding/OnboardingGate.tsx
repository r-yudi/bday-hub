...
type OnboardingGateProps = {
  peopleCount: number;
  mounted: boolean;
  onOpenAddModal?: (view: "menu" | "quick" | "csv") => void;
};

type Step = 1 | 2 | 3 | 4;

export function OnboardingGate({ peopleCount, mounted, onOpenAddModal }: OnboardingGateProps) {
